    ...
    script.onload = () => {
      ...
      tokenClientRef.current = window.google.accounts.oauth2.initTokenClient({
        ...
        callback: async (tokenResponse) => {
          ...
          setError('')
          try {
            const backendRes = await api.post('/api/auth/admin/google', {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <Logo size={32} />
        <h1 style={{ color: 'white', fontFamily: 'var(--font-heading)', fontSize: 28, fontWeight: 700, margin: 0 }}>
          Admin Panel
        </h1>
        ...
        {error && (
          <p style={{ color: '#FCA5A5', fontSize: 14, margin: 0, maxWidth: 320 }}>
            {error}
          </p>
        )}
      </div>
