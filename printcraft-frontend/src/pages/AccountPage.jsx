                    ...
                    {orders.map(o => (
                      <div key={o.id} style={{ border:'1px solid var(--divider)', borderRadius:'var(--radius-md)', padding:20, background:'white', boxShadow:'var(--shadow-sm)' }}>
                        ...
                        <div style={{ display:'flex', gap:8, flexWrap:'wrap' }}>
                          ...
                          <a href={`https://wa.me/919999999999?text=ORDER_ID:%20${o.id}%0ASIZE:%20${o.productSizeInches}%0AFRAME:%20${o.frameTypes}%0ATHICKNESS:%20${o.productThickness}`}
                            target="_blank" rel="noopener noreferrer"
                            style={{ display:'inline-flex', alignItems:'center', gap:6, padding:'8px 14px', borderRadius:'var(--radius-sm)', border:'1px solid #25D366', color:'#25D366', fontSize:13, fontWeight:600, textDecoration:'none' }}>
